...
(function (PLUGIN_TYPE) {
    PLUGIN_TYPE["CONSOLE_PLUGIN"] = "CONSOLE_PLUGIN";
    PLUGIN_TYPE["ERROR_PLUGIN"] = "ERROR_PLUGIN";
    PLUGIN_TYPE["DOM_PLUGIN"] = "DOM_PLUGIN";
    PLUGIN_TYPE["HISTORY_PLUGIN"] = "HISTORY_PLUGIN";
    PLUGIN_TYPE["PERFORMANCE_PLUGIN"] = "PERFORMANCE_PLUGIN";
})(PLUGIN_TYPE || (PLUGIN_TYPE = {}));

const _global = window;
class Global {
    static errorBoundary(err) {
        var _a;
        const errorPlugin = (_a = this.plugins) === null || _a === void 0 ? void 0 : _a.find((item) => item.name === "ERROR_PLUGIN");
        errorPlugin === null || errorPlugin === void 0 ? void 0 : errorPlugin.handleError(err);
    }
}
...
class DomPlugin {
    constructor(params) {
        this.name = PLUGIN_TYPE.DOM_PLUGIN;
        const { options, breadcrumb, reportData } = params;
        this.options = options;
        this.breadcrumb = breadcrumb;
        this.reportData = reportData;
...
class ErrorPlugin {
    constructor(params) {
        this.name = PLUGIN_TYPE.ERROR_PLUGIN;
...
class ConsolePlugin {
    constructor(params) {
        this.name = PLUGIN_TYPE.CONSOLE_PLUGIN;
...
class HistoryPlugin {
    constructor(params) {
        this.name = PLUGIN_TYPE.HISTORY_PLUGIN;
        const { options, breadcrumb, reportData } = params;
        this.options = options;
        this.breadcrumb = breadcrumb;
        this.reportData = reportData;
...
class PerformancePlugin {
    constructor(params) {
        this.name = PLUGIN_TYPE.PERFORMANCE_PLUGIN;
        const { options, breadcrumb, reportData } = params;
        this.options = options;
        this.breadcrumb = breadcrumb;
        this.reportData = reportData;
...
class VuePlugin {
    ...
    setup() {
        var _a;
        const Vue = (_a = this.options) === null || _a === void 0 ? void 0 : _a.vue;
        if (Vue && Vue.config) {
            const that = this;
    ...
    handleData(collectedData, vm) {
        const sendData = this.transformData(collectedData, vm);
        this.reportData.send(sendData);
    }
    transformData(collectedData, vm) {
        const Vue = this.options.vue;
        if (Vue === null || Vue === void 0 ? void 0 : Vue.version) {
            switch (getBigVersion(Vue === null || Vue === void 0 ? void 0 : Vue.version)) {
                case 2:
                    return Object.assign(Object.assign({}, collectedData), vue2VmHandler(vm));
                case 3:
                    return Object.assign(Object.assign({}, collectedData), vue3VmHandler(vm));
                default:
...
class ReportDataController {
    ...
    getTransportData(data) {
        var _a;
        const info = Object.assign(Object.assign({}, data), { userInfo: this.getAuthInfo(), uuid: this.uuid, releaseVersion: (_a = this.options) === null || _a === void 0 ? void 0 : _a.version, pageUrl: getLocationHref(), deviceInfo: Global.deviceInfo });
...
var _BaseClient_instances, _BaseClient_reportData, _BaseClient_plugins, _BaseClient_options, _BaseClient_breadcrumb, _BaseClient_registeredPlugins, _BaseClient_setupPlugins;
class BaseClient {
    constructor(options, plugins) {
        _BaseClient_instances.add(this);
        _BaseClient_reportData.set(this, void 0);
        _BaseClient_plugins.set(this, void 0);
        _BaseClient_options.set(this, void 0);
        _BaseClient_breadcrumb.set(this, void 0);
        _BaseClient_registeredPlugins.set(this, void 0);
        __classPrivateFieldSet(this, _BaseClient_options, readonly(options), "f");
        __classPrivateFieldSet(this, _BaseClient_plugins, plugins, "f");
        __classPrivateFieldSet(this, _BaseClient_registeredPlugins, new Map(), "f");
        const { maxBreadcrumbs = 20, beforePushBreadcrumb } = options;
        __classPrivateFieldSet(this, _BaseClient_breadcrumb, new Breadcrumb(maxBreadcrumbs, beforePushBreadcrumb), "f");
        __classPrivateFieldSet(this, _BaseClient_reportData, new ReportDataController({
            options,
            breadcrumb: __classPrivateFieldGet(this, _BaseClient_breadcrumb, "f"),
        }), "f");
        Global.options = options;
        Global.breadcrumb = __classPrivateFieldGet(this, _BaseClient_breadcrumb, "f");
        Global.reportData = __classPrivateFieldGet(this, _BaseClient_reportData, "f");
        __classPrivateFieldGet(this, _BaseClient_instances, "m", _BaseClient_setupPlugins).call(this);
    }
    get breadcrumbList() {
        return __classPrivateFieldGet(this, _BaseClient_breadcrumb, "f");
    }
    log(value) {
        var _a;
        (_a = __classPrivateFieldGet(this, _BaseClient_reportData, "f")) === null || _a === void 0 ? void 0 : _a.send({
    ...
    errorBoundary(err) {
        const errorPlugin = __classPrivateFieldGet(this, _BaseClient_registeredPlugins, "f").get(PLUGIN_TYPE.ERROR_PLUGIN);
        errorPlugin === null || errorPlugin === void 0 ? void 0 : errorPlugin.handleError(err);
    }
}
_BaseClient_reportData = new WeakMap(), _BaseClient_plugins = new WeakMap(), _BaseClient_options = new WeakMap(), _BaseClient_breadcrumb = new WeakMap(), _BaseClient_registeredPlugins = new WeakMap(), _BaseClient_instances = new WeakSet(), _BaseClient_setupPlugins = function _BaseClient_setupPlugins() {
    const PluginPrams = {
        breadcrumb: __classPrivateFieldGet(this, _BaseClient_breadcrumb, "f"),
        options: __classPrivateFieldGet(this, _BaseClient_options, "f"),
        reportData: __classPrivateFieldGet(this, _BaseClient_reportData, "f"),
    };
    Global.plugins = __classPrivateFieldGet(this, _BaseClient_plugins, "f").map((Plugin) => {
        const plugin = new Plugin(PluginPrams);
        __classPrivateFieldGet(this, _BaseClient_registeredPlugins, "f").set(plugin.name, plugin);
    });
};
