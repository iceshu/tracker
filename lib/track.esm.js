...
class ReportDataController {
    ...
    getTransportData(data) {
        const info = Object.assign(Object.assign({}, data), { userInfo: this.getAuthInfo(), uuid: this.uuid, pageUrl: getLocationHref(), deviceInfo: global$1.deviceInfo });
...
const TrackInit = (options) => {
    global$1.version = options === null || options === void 0 ? void 0 : options.version;
